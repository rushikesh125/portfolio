  ...
  return (
    <>
      <svg
        ...
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
        className={`timeline3-svg w-full rotate-180  ${isVisible ? "visible" : ""}`}
      >
        <defs>
          <linearGradient id="pathGradient" x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" stopColor="#3498db" stopOpacity="1" />
...
export const TimeLine4ForMobile = () => {
  const svgRef = useRef(null);
  const [isVisible, setIsVisible] = useState(false);
  ...
  return (
    <>
      <svg
        ...
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
        className={`timeline3-svg ms-5 w-1/2 rotate-180 ${isVisible ? "visible" : ""}`}
      >
        <defs>
          <linearGradient id="pathGradient" x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" stopColor="#3498db" stopOpacity="1" />
